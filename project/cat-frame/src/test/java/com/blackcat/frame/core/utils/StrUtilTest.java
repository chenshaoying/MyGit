...
public class StrUtilTest {
	...
	public void testRegExp() {
		String s = "http://hao.360.cn/?wd=1000";
		String [] a = s.split("/+");
		for(String s1 : a) {
			System.out.println(s1);			
		}
	...
	@Test
	public void testByetToInt() {
		int value = Integer.MAX_VALUE - 1;
		byte[] b = {127, -1 , -1 , -2};
		int j =(int) ( b[0]* (Math.pow(2, 24)) + b[1]* (Math.pow(2, 16)) +
				b[2]* (Math.pow(2, 8)) + b[3]);
		
		System.out.println(value == j);
		System.out.println((-1) & 0xFF);
		byte b1 = (byte) -1;
		System.out.println((byte)(b1 & 0xFF));
	...
	public void easyMockTest() {
		...
		//处理@Autowired @Resources注入的field
